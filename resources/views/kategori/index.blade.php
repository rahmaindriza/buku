...
<section class="max-w-5xl mx-auto p-4 mt-6">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-2xl font-semibold text-gray-800">📚 Daftar Kategori</h3>
    ...
    <form action="{{ route('kategori.index') }}" method="get" class="flex items-center mb-4 space-x-2">
        ...
        <table class="min-w-full bg-white border border-gray-400 rounded-md">
            <thead class="bg-gray-100 text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-sm font-semibold border border-gray-400">Nama Kategori</th>
